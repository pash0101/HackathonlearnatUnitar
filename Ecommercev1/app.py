...
# ===============================================================
                        # TRAIN THE ENGINE
# ===============================================================
data_path =r'D:\CraftsProject\Crafts_Shop\Ecommercev1\recommendation\WebProducts.csv'
...
'''
    ...
    ============================================
''' 
tflow.compat.v1.disable_eager_execution()
graph = tflow.compat.v1.get_default_graph()
#graph = tflow.get_default_graph()

stemmer = LancasterStemmer()
data_chatPath=r'D:\CraftsProject\Crafts_Shop\Ecommercev1\chatbot\training_data'
data = pickle.load( open(data_chatPath, "rb") )
words = data['words']
documents = data['documents']
classes = data['classes']

jsonPath_data=r'D:\CraftsProject\Crafts_Shop\Ecommercev1\chatbot\intent.json'
with open(jsonPath_data) as json_data:
    intents = json.load(json_data)

# load the model
model_path =r'D:\CraftsProject\Crafts_Shop\Ecommercev1\chatbot\chatmodel.h5'
